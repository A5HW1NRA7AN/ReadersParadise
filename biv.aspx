<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="biv.aspx.cs" Inherits="Demo.WebForm12" %>
            ...
            <div class="card">
               <div class="card-body">
                  <div class="row">
                     <div class="col">
                        <center>
                           <h4 style="background-color:teal; color:white; padding:10px; border-radius:5px;">Book Inventory List</h4>
                        </center>
                     </div>
                  </div>
                  <div class="row">
                                               ...
                                               <div class="row">
                                                   ...
                                                   <div class="row">
                                                    <div class="col-12">
                                                        ...
                                                        Book -
                                                        <asp:Label ID="Label10" runat="server" Font-Bold="True" Font-Italic="True" Font-Size="Smaller" Text='<%# Eval("book_description") %>'></asp:Label>
