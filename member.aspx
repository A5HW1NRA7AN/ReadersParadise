<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="member.aspx.cs" Inherits="Demo.WebForm6" %>
            ...
            <div class="card">
               <div class="card-body">
                  <div class="row">
                     <div class="col">
                        <center>
                           <h4 style="background-color:teal; color:white; padding:6px; border-radius:5px;" >Member Details</h4>
                        </center><br />
                     </div>
                  </div>
                  <div class="row">
                     <!--<div class="col">
                        <center>
                           <img width="100px" src="custom/imgs/u1.png" />
                        </center>
                     </div>-->
                  </div>
                  <div class="row">
            ...
            <div class="card">
               <div class="card-body">
                  <div class="row">
                     <div class="col">
                        <center>
                           <h4 style="background-color:teal; color:white; padding:10px; border-radius:5px;">Member List</h4>
                        </center>
                     </div>
                  </div>
                  <div class="row">
